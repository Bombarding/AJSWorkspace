...
public class RobotMap extends Applet
{
...
//int x[] = polygonX;
//int y[] = polygonY;
int [] px = {150,50,256,196,300,196,256,169,150,131,44,104,0,104,44,50,150};
int [] py = {0,103,44,131,150,169,256,196,300,196,256,169,150,131,44,50,0};
