...
public class PongPanel extends ________ implements __________ , __________
{
    ...
    public void step()
    {
        ...
        if(playing)
        {
            ...
            if (_________) 
            {
                if (_________ + _____________ + ___________ < getHeight()) 
                {
            ...
            if (________) 
            {
                if (________ + _____________+ ____________ < getHeight()) 
                {
            ...
            {
                ballDeltaY *= ____;//boolean operator for multiplication
            ...
            { 
                ...
                if (nextBallTop > playerOneBottom || nextBallBottom < playerOneTop) 
                {
                    ...
                    if (playerTwoScore == _____) //win conditions
                    {
                        playing = ________;
                        gameOver = _________;
                    }
            ...
            if (nextBallRight > playerTwoLeft) {
                ...
                if (nextBallTop > playerTwoBottom || nextBallBottom < playerTwoTop) {
                    ...
                    if (playerOneScore == _____) //win conditions
                    {
                        playing = ______;
                        gameOver = ______;
                    }
    ...
    public void paintComponent(Graphics g)
    {
        ...
        else if (playing) 
        {
            ...
            //draw the ball
            g.fillOval(______, ________, diameter, diameter);
            

            //draw the paddles
            g.setColor(__________);
            g.fillRect(_______,__________, playerOneWidth, playerOneHeight);
            g.setColor(__________);
            g.fillRect(playerTwoX, playerTwoY, _________, _________);
        }
        else if (gameOver) 
